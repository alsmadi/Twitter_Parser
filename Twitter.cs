...
namespace TwitterScraper
{
    static class Twitter
    {
        ...
        * CLASS VARIABLES
        *********************************************************/
        private static string _accessToken = "1976215495YyXTEpyECgiwOsL7BCoDAohVYpwGPPAzcyMlnkT";
        private static string _accessTokenSecret = "QhwPS2HYkiV2vznZ0yULm2z1x5g4tUctM2JItLH3MEC3h";
        private static string _consumerKey = "UyK8wQUDghgW5cnZFFXOQQ";
        private static string _consumerSecret = "OLepmuMMvnHG6sXLdWYLObwskOBJDCLOUUczgeguEs";
